...
const doubleRight = '/assets/doubleRight.svg';
const plus = '/assets/plus.svg';
const heroSection = '/assets/heroSection.webp';
const sideBanner = '/assets/sideBanner.webp';
const transparentLogo = `/assets/transparentLogo.webp`;
...
const images = {
  ...
  fullLogotransparent: fullLogotransparent,
  calender: calender,
  clock: clock,
  game: game,
  user: user,
